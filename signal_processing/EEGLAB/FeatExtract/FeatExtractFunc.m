...
for k = 1:nChannels
    ...
    % Potential bandpower of 1-2, 1.5 - 2.5
    onePwelch = bandpower(psdWelch,fWelch,[1,2],'psd')';
    oneFivePwelch = bandpower(psdWelch,fWelch,[1.5,2.5],'psd')';
    twoPwelch = bandpower(psdWelch,fWelch,[2,3],'psd')';
    twoFivePwelch = bandpower(psdWelch,fWelch,[2.5,3.5],'psd')';
    threePwelch = bandpower(psdWelch,fWelch,[3,4],'psd')';
    threeFivePwelch = bandpower(psdWelch,fWelch,[3.5,4.5],'psd')';
    fourPwelch = bandpower(psdWelch,fWelch,[4,5],'psd')';
    fourFivePwelch = bandpower(psdWelch,fWelch,[4.5,5.5],'psd')';
    fivePwelch = bandpower(psdWelch,fWelch,[5,6],'psd')';
    fiveFivePwelch = bandpower(psdWelch,fWelch,[5.5,6.5],'psd')';
    sixPwelch = bandpower(psdWelch,fWelch,[6,7],'psd')';
    sixFivePwelch = bandpower(psdWelch,fWelch,[6.5,7.5],'psd')';
    sevenPwelch = bandpower(psdWelch,fWelch,[7,8],'psd')';
    eightfourteenPwelch = bandpower(psdWelch,fWelch,[8,14],'psd')';
    fourteentwentyPwelch = bandpower(psdWelch,fWelch,[14,20],'psd')';
...
% Features with short bands
[features, labels] = FeatureLabelsPerEpoch( ...
    onePwelch, 'onePwelch', oneFivePwelch, 'oneFivePwelch', twoPwelch, 'twoPwelch', twoFivePwelch, 'twoFivePwelch', ...
    threePwelch, 'threePwelch', threeFivePwelch, 'threeFivePwelch', fourPwelch, 'fourPwelch', fourFivePwelch, 'fourFivePwelch', ...
    fivePwelch, 'fivePwelch', fiveFivePwelch, 'fiveFivePwelch', sixPwelch, 'sixPwelch', sixFivePwelch, 'sixFivePwelch', ...
    sevenPwelch, 'sevenPwelch', eightfourteenPwelch, 'eightfourteenPwelch', fourteentwentyPwelch, 'fourteentwentyPwelch', ...
