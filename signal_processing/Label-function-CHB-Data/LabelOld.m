function [SessMatch,SmplRate, Out] = LabelOld(TxtLoc)
% SessMatch is for testing given as an output and should be removed for
% final use
...
Out = zeros(length(SessMatch),ceil(3600*SmplRate)); 
